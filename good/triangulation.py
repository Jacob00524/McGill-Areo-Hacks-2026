...
class Box3DTracker:
    def __init__(self):
        ...
        self.front_x_min_px = 100
        self.front_x_max_px = 540
        self.front_y_min_px = 80
        self.front_y_max_px = 400
        ...
        self.side_z_min_px = 120
        self.side_z_max_px = 500
        self.side_y_min_px = 85
        self.side_y_max_px = 405
